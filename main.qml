...
import "weatherll.js" as WeatherFunctionsll
            ...
            Rectangle{
                ...
                Image{
                    ...
                    states: State {
                        ...
                        PropertyChanges { target: collimage; scale: 0.8; opacity: 0}
                        PropertyChanges { target: logoimage; scale: 0.8; opacity: 1}
                        PropertyChanges { target: mainMouseArea; visible: true }
                    }

                    transitions: Transition {
                        NumberAnimation { properties: "scale, opacity"; easing.type: Easing.InBack; duration: 10000  }
                    }
                }
                Image {
                    id: logoimage
            ...
            Rectangle{
                ...
                Rectangle{
                    ...
                    Image {
                        ...
                        height: 72
                        width: 72
                        source: "pictures/Power-Shutdown.png"

                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
                                alertwindowaa.visible = true;
                                vkbdlogin.visible = false;
 ...
 Please re enter password!"
                ...
                Rectangle{
                    ...
                    Rectangle{
                        ...
                        Text{
                            id:alertmsgaa
                            x:60; y: 80
                            text:"Do you really wish to quit?"
                        ...
                        Rectangle{
                            ...
                            Text{id:okayaa; text: "    yes"; font.family: "Segoe UI"; horizontalAlignment: Text.AlignHCenter; color: "black"; font.pointSize: 20; }
                        ...
                        Rectangle{
                            ...
                            Text{id:noaa; text: "    no"; font.family: "Segoe UI"; horizontalAlignment: Text.AlignHCenter; color: "white"; font.pointSize: 20}

                            MouseArea{
                                anchors.fill: parent
                                onClicked: {
                                    alertwindowaa.visible=false;
                                    vkbdlogin.visible = true;
                                }
                            }
                ...
                Column{
                    ...
                    Rectangle{
                        ...
                        Timer {
                            ...
                            onTriggered: WeatherFunctionsll.getWeatherll();
                        }
                        ...
                        Text{
                            ...
                            MouseArea{
                                ...
                                onClicked: {
                                    ...
                                    useroptions.visible = false;
                                    //blacktrans.visible = true;
                                     loginscreen.powerButton.visible = true;
                                }
                            }
                        }
                                ...
                                Image {
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            playingMini.visible=false
                                            playMini.visible = true
                                ...
                                Image {
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            playingMini.visible = true
                                            playMini.visible = false
                                            songNameMini.text = " "

                                            playmusic1.pause();playmusic2.pause();  playmusic.pause();
                        ...
                        MouseArea{
                            ...
                            onClicked:
                            {
                                ...
                                else
                                {
                                    browser.y = 983;
                                    listmin.y = 1000;
                                    browserfeaturewindow.opacity = 1;
                                    maincircle.visible = false;
                                    blacktrans.visible = true;
                                }
                            }
                ...
                Rectangle{
                    ...
                    Rectangle{
                        ...
                        Rectangle{
                            ...
                            Row{
                                ...
                                Rectangle{
                                    ...
                                    Text{id:grosave; text: "  save"; font.family: "Segoe UI"; color: "white"; font.pointSize: 20; anchors.horizontalCenter: parent}

                                    MouseArea{
                                        anchors.fill: parent
                                        onClicked: {
                                            grosave.color = "black"
                                            if(groitemname.text!="dddd")
                                            {
                                                Variables.groitemcount++;
                                                // Variables.groitemcount=Variables.groitemcount+1;
                                                var v = Variables.groitemcount;
                                                if(v===1) {
                                                    gadd1.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd1.visible = true;
                                                }
                                                else if(v===2)  {
                                                    gadd2.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd2.visible = true;
                                                }
                                                else if(v===3)  {
                                                    gadd3.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd3.visible = true;
                                                }
                                                else if(v===4)  {
                                                    gadd4.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd4.visible = true;
                                                }
                                                else if(v===5)  {
                                                    gadd5.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd5.visible = true;
                                                }
                                                else if(v===6)  {
                                                    gadd6.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd6.visible = true;
                                                }
                                                else {
                                                    gadd7.text = "- "+groitemname.text+" - "+groitemdue.text;
                                                    gadd7.visible = true;
                                                }
                                            }
                                        }

                                        onReleased: {grosave.color = "white"}
                                ...
                                Rectangle{
                                    ...
                                    Text{id:grocancel; text: " cancel"; font.family: "Segoe UI"; color: "white"; font.pointSize: 20; anchors.horizontalCenter: parent}

                                    MouseArea{
                                        anchors.fill: parent
                                        onClicked: {
                                            groadditemWindow.visible = false
                                            tdsave.color = "black"
                                        }
                                    }
                                }
                        ...
                        Scrollable {
                            id: groFlickArea
                            anchors.fill: parent
                            contentWidth: groWindow.width
                            contentHeight: groWindow.height
                            flickableDirection: Flickable.VerticalFlick
                            clip: true
                            ...
                            Column{
                                id:grolist
                                anchors.fill: parent
                                Text{id:groitem1; text: "- Potato - 1lb"; font.pointSize: 30; font.family: "Segoe WP Light";

                                }
                                Text{id:groitem2; text: "- Tomato - 2lb"; font.pointSize: 30; font.family: "Segoe WP Light";

                                }
                                Text{id:groitem3; text: "- Onion - 2lb"; font.pointSize: 30; font.family: "Segoe WP Light";
                                    MouseArea{
                                        anchors.fill: parent
                                        onPressAndHold: {
                                            grodeleteitemWindow.visible = true;
                                            Variables.delitemid=groitem3.text;
                                        }
                                    }
                                }
                                Text{id:groitem4; text: "- Brinjal - 2lb"; font.pointSize: 30; font.family: "Segoe WP Light";

                                }
                                Text{id:groitem5; text: "- Carrot - 3lb"; font.pointSize: 30; font.family: "Segoe WP Light";

                                }
                                Text{id:groitem6; text: "- Brocolli - 1lb"; font.pointSize: 30; font.family: "Segoe WP Light";

                                }
                                Text{id:groitem7; text: "- turnips - 4lb"; font.pointSize: 30; font.family: "Segoe WP Light";
                                }


                                Text{id:gadd1; text: "- new item1"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}
                                Text{id:gadd2; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                                Text{id:gadd3; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                                Text{id:gadd4; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                                Text{id:gadd5; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                                Text{id:gadd6; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                                Text{id:gadd7; text: "- Get new Icard"; font.pointSize: 30; font.family: "Segoe WP Light"; visible: false}

                            }

                            ScrollBar {
                                flickable: groFlickArea
                                vertical: true
                            }
                ...
                Rectangle{
                    ...
                    Rectangle {
                        ...
                        Text{id:albumname;text:"In Your Atmosphere"
                            x: 40
                            font.family: "Segoe WP Light"
                            font.pointSize: 26;color:"black"
                            font.bold: true
                            font.italic:true;
                            anchors.top:songname.bottom;}
                        Image{
                            id:album;x:100;y:115;width:500;height:350;
                                ...
                                Image{id:previous;//x:60;y:110;
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            n1.font.family="Segoe WP Semibold"
                                            n2.font.family= "Segoe WP Light"
                                            n3.font.family= "Segoe WP Light"
                                            n3.color="black;"
                                            playmusic2.stop();
                                            // songNameMini.text = "Right Now Na Na"
                                            if(playing.visible == true)
                                                songNameMini.text = "Right Now Na Na"
                                ...
                                Image{id:play;//x:160;y:100;
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            n2.font.family="Segoe WP Semibold"
                                            n1.font.family= "Segoe WP Light"
                                            n3.font.family= "Segoe WP Light"
                                            playmusic1.stop();playmusic2.stop();  playmusic.play();
                                            //songNameMini.text = "Lightning"
                                            if(playing.visible == true)
                                ...
                                Image{id:playing;//x:160;y:100;
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {
                                            ...
                                            n1.font.family= "Segoe WP Light"
                                            n3.font.family= "Segoe WP Light"
                                            playmusic1.stop();playmusic2.stop();  playmusic.pause();
                                ...
                                Image{id:next;//x:330;y:110;
                                    ...
                                    MouseArea{
                                        ...
                                        onClicked: {playmusic.stop();
                                            ...
                                            playmusic2.play();
                                            playmusic1.stop();
                                            n3.font.family="Segoe WP Semibold"
                                            n2.font.family= "Segoe WP Light"
                                            n1.font.family= "Segoe WP Light"
                                            //songNameMini.text = "Umbrella"
                                            if(playing.visible == true)
                        ...
                        Rectangle{color:"#1BA1E2";x:675;y:88
                            ...
                            Column{
                                x: 10
                                spacing:5;
                                Text{id:n1;text:"Right Now";font.family: "Segoe WP Light"
                                ...
                                Text{id:n2;text:"Lightning";font.pointSize: 20;font.family: "Segoe WP Light"
                                    MouseArea{
                                        anchors.fill: parent
                                ...
                                Text{id:n3;text:"Umbrella";font.pointSize: 20;font.family: "Segoe WP Light"
                                    MouseArea{
                                        anchors.fill: parent
                                        onClicked: {
                                            songname.text="Umbrella"
                                ...
                                Text{text:"Smack down";font.pointSize: 20;font.family: "Segoe WP Light"}
                                Text{text:"Words";font.pointSize: 20;font.family: "Segoe WP Light"}
                                Text{text:"Smile";font.pointSize: 20;font.family: "Segoe WP Light"}
                                Text{text:"Pretty Woman";font.pointSize: 20;font.family: "Segoe WP Light"}
                                Text{text:"Heartbeat";font.pointSize: 20;font.family: "Segoe WP Light"}
    ...
    */
                ...
                ParallelAnimation {
                    id:opening
                    running: false
                    NumberAnimation { target:circleup ; properties: "y"; to:90; duration: 1000; easing.type: Easing.OutCurve }
                    NumberAnimation { target: circledown; properties: "y"; to:700; duration: 1000; easing.type: Easing.OutCurve }

                }
                ParallelAnimation{
                    id:openFeatureWindow;       running:false;

                    PropertyAnimation{target: featurewindow; properties:"width";from:0; to:1200;duration:1000;}
                    PropertyAnimation{target: featurewindow; properties:"height";from:0; to:660;duration:1000;}
                    PropertyAnimation{target: featurewindow; properties:"z";from:0; to:1;duration:1000;}
                }
                ParallelAnimation{
                    id:closeFeatureWindow;       running:false;

                    PropertyAnimation{target: featurewindow; properties:"width";from:1200; to:0;duration:1000;}
                    PropertyAnimation{target: featurewindow; properties:"height";from:660; to:0;duration:1000;}
                    PropertyAnimation{target: featurewindow; properties:"z";from:1; to:0;duration:1000;}
                }
                //Parallel Animation for opening disc

                ParallelAnimation {
                    id:closing
                    running: false

                    NumberAnimation { target: circleup; properties: "y"; to:240; duration: 1000; easing.type: Easing.InCurve }
                    NumberAnimation { target: circledown; properties: "y"; to:550; duration: 1000 }
                }
                ...
                Timer {
                    id:openfeatureWindow
                    interval: 1000
                    running: false
                    repeat: false

                    onTriggered: {
                        featurewindow.opacity=0.1;
                        featurewindow.visible=true;
                        console.log("opening");
                        openFeatureWindow.start()
                    }
                }
                /**delay COOKING*/
                Timer {
                ...
                Timer {
                    ...
                    onTriggered: {
                        featurewindow.visible=false;
                        blacktrans.visible=false;
                        circleup.visible=false;
                        circledown.visible=false;
                        maincircle.visible=true;
                    }
                }
                Timer {
                    id:closefeatureWindow
                    interval: 500
                    running: false
                    repeat: false

                    onTriggered: {
                        featurewindow.opacity=0;
                        featurewindow.visible=false;
                        closeFeatureWindow.start()
                ...
                Item{
                    ...
                    Image{
                        id: circleup
                        source: "pictures/pokeball-cut-up.gif"
                        visible: false
                        x:450; y:240;
                    }
                    Image{
                        id: circledown
                        source: "pictures/pokeball-cut-down.gif"
                        visible: false
                        x:450; y:550;
                    }
                }
